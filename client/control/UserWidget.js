...
Class.create("UserWidget", {
	...
	updateGui : function(){
		...
		if(oUser != null) 
		{
			if(oUser.id != 'guest') 
			{
				logging_string = '<div class="user_widget_label"><message message_id="142">'+I18N[142]+'</message><i message_title_id="189" title="'+I18N[189]+'">'+ oUser.id+' </i></div><div class="inlineBarButtonLeft" style="-moz-border-radius: 0pt 5px 5px 0pt;border-radius: 0pt 5px 5px 0pt;border-left-style:none; border-width:1px;"><img width="16" height="16" style="height: 6px; width: 10px; margin-top: 9px; margin-left: 3px; margin-right: 3px;" message_title="189" title="'+I18N[189]+'" src="'+THEME.path+'/image/arrow_down.png"></div>';
			...
			{
				logging_string = '<div style="padding:3px 0 3px 7px;"><message message_id="143">'+I18N[143]+'</message></div>';
				this.element.addClassName('disabled');
			}
		}
		else 
		{
			logging_string = '<div style="padding:3px 0 3px 7px;"><message message_id="142">'+I18N[144]+'</message></div>';
			this.element.addClassName('disabled');
		}
