...
Class.create("SQLSearchEngine", SearchEngine, {
	...
	initGUI:function(){
		this.htmlElement.update('<div style="font-style:italic;color:#999;margin-top:5px;">'+I18N["sql.2"]+'</div><textarea id="sql_query" style="width:100%; overflow:auto;"></textarea><div class="dialogButtons"><img height="16" width="16" id="search_button" value="Search" style="margin-top:5px;cursor:pointer;" src="'+THEME.path+'/image/action/16/search.png" title="'+I18N["sql.3"]+'"/> <img height="16" width="16" id="clear_button" value="Clear" style="margin-top:5px;cursor:pointer;margin-right:5px;" src="'+THEME.path+'/image/action/16/fileclose.png" title="'+I18N["sql.4"]+'"/></div>');
