 ...
 */
Class.create("ViewDiaporama", View, {
	...
	initialize : function($super, oFormObject, options)
	{
		...
		if(app && app.user){
			...
			if(autoFit && autoFit == "true"){
				this.autoFit = true;
				this.fitToScreenButton.select('img')[0].src = ajxpResourcesFolder + '/images/action/22/zoom-fit-restore.png';
	...
	toggleFitToScreen : function(skipSave){
		...
		this.fitToScreenButton.select('img')[0].src = ajxpResourcesFolder + '/images/action/22/'+src+'.png';
