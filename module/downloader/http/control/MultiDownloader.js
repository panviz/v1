 ...
 */
 Class.create("MultiDownloader", {
	...
	addListRow : function( fileName, label )
	{
		...
		new_row_button.insert('<img src="'+THEME.path+'/image/action/16/download_manager.png" height="16" width="16" align="absmiddle" border="0"> '+(label ? label : getBaseName(fileName)));
