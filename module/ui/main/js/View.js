...
Class.create("View", Pane, {
	...
	initialize: function($super, oElement, options)
	{
		...
		this._registerObserver(document, "ajaxplorer:context_changed", this._onContextChanged);
		//this._registerObserver(document, "ajaxplorer:context_loading", loadingObs);
		//this._registerObserver(document, "ajaxplorer:component_config_changed", _onComponentConfig);
		//this._registerObserver(document, "ajaxplorer:selection_changed", _onSelectionChanged);
	...
	_initGUI : function(sFormId, fOnLoad, fOnComplete, fOnCancel, bOkButtonOnly, skipButtons)
	{
		...
		//if(fOnCancel){
			//this.title.select('#modalCloseBtn')[0].observe("click", function(){fOnCancel(modal.getForm());hideLightBox();});
		//}
		//else{
			//this.title.select('#modalCloseBtn')[0].observe("click", function(){hideLightBox();});
		//}			
