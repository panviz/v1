 ...
 * A selector for displaying provider list. Will hook to app:provider_list_refreshed.
 */
Class.create("ProviderSelect", {
  _defaultString: 'No Provider',
  ...
  initialize : function(oElement){
    ...
    this.show = true;
    this.createGui();
    document.observe("app:provider_list_refreshed", function(e){
