...
Object.extend(Function.prototype, (function() {
  ...
  **/
   ...
   *  any arguments given.
   *
   *  Behaves much like `setTimeout`, but the timeout is in seconds
   *  rather than milliseconds. Returns an integer ID that can be used to
   *  clear the timeout with `clearTimeout` before it runs.
   *
  ...
  **/
   ...
   *
   *  Behaves much like `setTimeout` with a delay set to `0`. Returns an
   *  ID that can be used to clear the timeout with `clearTimeout` before
   *  it runs.
   *
   *  ##### Example
   *
